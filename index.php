...
<html lang="en">
    <head>
        ...
        <link style type="text/css" href="./CSS/credential.css" rel="styleSheet"/>
    </head>
            ...
            <div class="col-lg-6">
              <div class="card-body p-md-5 mx-md-4">
                ...
                <div class="text-center">
                  ...
                  <h4 class="mt-1 mb-5 pb-1">Place to be App Dashboard</h4>
                </div>
    ...
    <p class="text-danger"><?php echo $_GET['error']; ?></p>
                ...
                <form action="<?php echo $_SERVER['PHP_SELF']; ?>"  method="POST">
                  ...
                  <div class="text-center pt-1 mb-4">
                    <input type="submit" name="submit" value="Login" class="btn btn-primary btn-block outline-none gradient-custom-2 mb-3" />
...
// login page databese data feaching code 
...
$sql="SELECT * FROM administrator WHERE email='$username' AND password='$password' limit 1";
$result = mysqli_query($conn, $sql);
$row = mysqli_num_rows($result);

if ($row>0) {
 
 while($fetchUser = mysqli_fetch_assoc($result)) {
     header("location: dashboard.php");
 }
}
    else {
           header("location: index.php?error=Inavalid Username or password");
    exit();
    }
}
}
